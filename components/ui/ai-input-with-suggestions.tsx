    ...
    return (
        <div className={cn("w-full py-4", className)}>
            <div className="relative max-w-xl w-full mx-auto">
                <div className="relative border border-white/10 focus-within:border-white/20 rounded-2xl bg-white/[0.03]">
                    <div className="flex flex-col">
                        ...
                        >
                            <Textarea
                                ...
                                className={cn(
                                    "max-w-xl w-full rounded-2xl pr-10 pt-3 pb-3 placeholder:text-white/70 border-none focus:ring text-white resize-none text-wrap bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 leading-[1.2]",
                                    `min-h-[${minHeight}px]`
                                )}
                                value={inputValue}
                                onChange={(e) => {
                                ...
                                <div className="absolute left-3 bottom-3 z-10">
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            "animate-fadeIn hover:bg-white/5 transition-colors duration-200",
                    ...
                    <CornerRightDown
                        className={cn(
                            "absolute right-3 top-3 w-4 h-4 transition-all duration-200 text-white",
                            inputValue
            ...
            <div className="flex flex-wrap gap-1.5 mt-2 max-w-xl mx-auto justify-start px-2 sm:px-4">
                {actions.filter((item) => item.text !== selectedItem).map(
                    ({ text, icon: Icon, colors }) => (
                        <button
                            ...
                            key={text}
                            className={cn(
                                "px-2 sm:px-3 py-1 sm:py-1.5 text-[10px] sm:text-xs font-medium rounded-full",
